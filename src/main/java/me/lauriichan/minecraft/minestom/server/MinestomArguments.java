...
import me.lauriichan.minecraft.minestom.server.util.cli.ArgumentGroup;
import me.lauriichan.minecraft.minestom.server.util.cli.IArgument;
...
public final class MinestomArguments {
    ...
    static {
        ...
        MODULE_DIR = group
            .argument(IArgument.string("module-dir", "PATH", "Sets the directory where the jar modules should be loaded from.", "modules"));
        MODULE_DATA_DIR = group.argument(
            IArgument.string("module-data-dir", "PATH", "Sets the directory where the jar modules' data should be saved.", "modules"));
        SYSTEM_DATA_DIR = group
            .argument(IArgument.string("system-data-dir", "PATH", "Sets the directory where system data should be saved.", "system"));
    }
