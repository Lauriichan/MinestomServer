...
import me.lauriichan.minecraft.minestom.module.IModuleDescription.Dependency;
import me.lauriichan.minecraft.minestom.module.IModuleDescription.Version;
...
final class DependencyGraph {
    ...
    private static class Node {
        ...
        public String id() {
            return entry.getC().id();
        }
        
        public ObjectList<Dependency> dependencies() {
            return entry.getC().dependencies();
        }

        public Version version() {
            return entry.getC().version();
        }
