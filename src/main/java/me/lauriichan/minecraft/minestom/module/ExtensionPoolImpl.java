...
import me.lauriichan.minecraft.minestom.extension.ExtensionCondition;
...
import me.lauriichan.minecraft.minestom.extension.processor.ExtensionProcessor;
...
final class ExtensionPoolImpl<T extends IExtension> implements IExtensionPool<T> {
    ...
    ExtensionPoolImpl(final IMinestomModule owningModule, final Class<? extends IExtension> extensionType, final Class<T> type,
        ...
        for (IMinestomModule module : modules) {
            ...
            final IDataSource source = owningModule.resource("jar://" + ExtensionProcessor.extensionPath(typeName));
            ...
            try (BufferedReader reader = source.openReader()) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    final Class<?> clazz = ClassUtil.findClass(line);
                    if (clazz == null) {
